...
export default function ProjectPage() {
  ...
  const [chatActivities, setChatActivities] = useState([
    ...
    },
    {
      id: 4,
      type: "deposit",
      text: "3HtRLA...qtiN deposited $9.91 at Tier 0 (Instant)",
    },
  ]);
      ...
      <div className="w-full relative h-[250px] md:h-[300px] rounded-[24px] overflow-hidden mb-5 flex items-end shadow-sm border-[4px] border-white bg-slate-900">
        ...
        <div className="relative z-10 w-full bg-white mx-3 mb-3 md:mx-4 md:mb-4 rounded-[16px] p-3 md:p-4 flex flex-col md:flex-row items-start md:items-center justify-between shadow-sm border border-slate-100/50 backdrop-blur-md">
          ...
          <div className="flex items-center gap-4">
            <div className="w-[80px] h-[80px] bg-black rounded-xl flex flex-col items-center justify-center text-white font-bold text-5xl italic tracking-tighter shrink-0">
              E
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-slate-500 font-medium text-[12px] tracking-tight">
                Be part of the production. Back the next global phenomenon.
              </p>
          ...
          <div className="flex items-center gap-5 md:gap-8 px-2 md:px-4 mt-4 md:mt-0 ml-auto md:ml-0">
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-slate-500 mb-0.5 tracking-tight">
                Ends in
              </span>
              <span className="text-[14px] font-medium text-slate-900 leading-none">
                12:56
              </span>
            </div>
            <div className="flex flex-col">
        ...
        <div className="w-full lg:w-[320px] shrink-0 flex flex-col gap-4">
          ...
          <div className="bg-[#f0f0f5]/80 rounded-[16px] border border-white shadow-sm flex flex-col p-2 h-[400px]">
            ...
            <div className="bg-white rounded-[12px] p-1 flex shadow-sm mb-3">
              ...
              >
                Depositors{" "}
                <span className="text-[8px] bg-slate-200 px-1 py-0.5 rounded uppercase font-bold text-slate-600">
                  35
                </span>
              </button>
              <button
              ...
              <div className="flex flex-col flex-1 min-h-0 px-1">
                ...
                <div className="mb-2 shrink-0">
                  <h3 className="text-[9px] font-bold tracking-widest flex items-center">
                    ...
                    <span className="w-3.5 h-3.5 rounded bg-slate-200 flex items-center justify-center text-[8px] text-slate-500 font-bold ml-1.5">
                      4
                    </span>
                  </h3>
                </div>
                ...
                <div className="flex flex-col flex-1 gap-0.5 min-h-0 overflow-y-auto scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                  {depositors.map((dep, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between text-[11px] py-1.5 hover:bg-slate-200/50 rounded-lg px-2 -mx-1 transition-colors cursor-pointer group"
                    >
                      <div className="flex items-center gap-2">
                        <span className="font-semibold text-slate-800 min-w-[75px]">
                          {dep.rank}
                        </span>
                      ...
                      <div className="flex items-center gap-2 text-right">
                        ...
                        <span className="font-bold text-blue-500 w-8 text-[9px]">
                          {dep.percentage}
                        </span>
                      </div>
                    </div>
              ...
              <div className="flex flex-col flex-1 min-h-0 px-2 py-2">
                  ...
                  {chatActivities.map((activity) => {
                    if (activity.type === "deposit") {
                      return (
                        <div
                          key={activity.id}
                          className="bg-[#eefcf4] p-3 rounded-2xl flex items-center gap-3 w-full border border-white/40 shadow-sm"
                        >
                    ...
                    return (
                      <div key={activity.id} className="flex gap-3">
                        ...
                        <div className="flex flex-col py-0.5 flex-1">
                          ...
                          <p className="text-slate-900 text-[15px] font-medium mb-3">
                            {activity.text}
                          </p>
                ...
                <div className="flex items-center gap-2 mt-auto">
                  <input
                    ...
                    placeholder={
                      isConnected ? "Type a message..." : "Log in to chat"
                    }
          ...
          <div className="bg-white rounded-[16px] p-2.5 flex flex-col shadow-sm border border-slate-200/60">
            ...
            <div className="flex gap-2 mb-2.5">
              ...
              <button
                onClick={() =>
                  setTradeAmount(tradeMode === "sell" ? "12.5" : "100")
                }
            ...
            <div className="flex items-center justify-between mt-2.5 px-0.5">
              ...
              <div className="flex items-center gap-1.5 text-slate-500 font-medium text-[10px]">
                ...
                {isConnected ? (
                  <>
                    <span className="text-slate-900 font-bold">2.4 BNB</span>
                  </>
                ) : (
                  <>
                    <span className="text-slate-900 font-bold">0 BNB</span>
                  </>
                )}
        ...
        <div className="flex-1 w-full min-w-0 bg-white border border-slate-200/60 rounded-[20px] shadow-sm p-4 h-[560px] overflow-y-auto scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                id: 1,
                title: "Darkness Ablaze #143/189 Sala...",
                price: "3.15",
                lastSale: "3.14",
                img: "https://images.unsplash.com/photo-1620336655055-088d06e36bf0?q=80&w=400&auto=format&fit=crop",
              },
              {
                id: 2,
                title: "Astral Radiance #165/189 Hea...",
                price: "3.15",
                lastSale: "2.80",
                img: "https://images.unsplash.com/photo-1620336655055-088d06e36bf0?q=80&w=400&auto=format&fit=crop",
              },
              {
                id: 3,
                title: "Surging Sparks #180/191 Flam...",
                price: "3.15",
                lastSale: "3.00",
                img: "https://images.unsplash.com/photo-1620336655055-088d06e36bf0?q=80&w=400&auto=format&fit=crop",
              },
              {
                id: 4,
                title: "Paldea Evolved #243/193 Ting...",
                price: "3.21",
                lastSale: "3.23",
                img: "https://images.unsplash.com/photo-1620336655055-088d06e36bf0?q=80&w=400&auto=format&fit=crop",
              },
              ...
              >
                <div className="bg-gradient-to-b from-slate-700 to-black p-2 h-[180px] flex items-center justify-center">
                  <img
                    src={nft.img}
                    className="w-[110px] h-[150px] object-cover rounded shadow-md border border-white/20 hover:scale-105 transition-transform"
                    alt={nft.title}
                  />
                </div>
                <div className="p-3">
                  <h4 className="text-[10px] font-bold text-slate-800 truncate mb-1.5">
                    {nft.title}
                  </h4>
